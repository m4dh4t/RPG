...
public abstract class Projectile extends MovableAreaEntity implements Interactor, FlyableEntity {
    ...
    public void update(float deltaTime) {
        ...
        if (!position.equals(MAX_TRAVEL) && getOwnerArea().canEnterAreaCells(this, Collections.singletonList(position.jump(getOrientation().toVector())))) { //Cell in front of the projectile
